...
from src.entity.artifact_entity import DataTransformationArtifact,DataIngestionArtifact,DataValidationArtifact,DataIngestionArtifact
...
class DataTransformation:
    ...
    def get_data_transformer_object(self)-> Pipeline:
        logging.info("Entered get_data_tranformer_object method of DataTranformer class ")
        ...
        try:
            ...
            num_columns=self.__schema_config['mm_columns'] 
            ...
            logging.info("Excited get_data_transformer_object method of DataTransformation class")
