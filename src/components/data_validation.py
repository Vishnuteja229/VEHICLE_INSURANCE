...
class DataValidation:
    ...
    def is_column_exist(self,df:DataFrame)->bool:
        try:
            ...
            return False if len(missing_numerical_columns or len(missing_categorical_columns))>0 else True                         
        except Exception as e:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            if not status:
                validation_error_msg+= f"Columns are missing in trading dataframe."
            else:
            ...
            if not status:
                validation_error_msg+=f"columns are missing in training datframe."
            else:
